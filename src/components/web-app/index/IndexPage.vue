...
<template>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-6">
                            <div class="slider__content">
                                <h6 class="sub-title">House of</h6>
                        ...
                        <div class="col-xxl-6 col-xl-5 col-lg-6">
                            <div class="slider__img text-center">
                                <img src="@/assets/images/ai-meme.png">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="memegents-section p-120">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="about-info text-center">
                        <div class="section-title mb-30">
                            <h2>About <span>Memegents</span></h2>
                        </div>
                        <div class="about-des">
                            <p>
    ...
    <section class="features-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title mb-30">
                        <h2>ALIVE AND <span>FEATURE RICH</span></h2>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="buy-points">
                        <ul>
                            <li>
                                Interactive on Telegram, Discord and Twitter, Memegents will engage based on their own
                                thoughts!
                            </li>
                            <li>
                                Built on Solana. Memegents have direct access to all the digital assets and services on
                                SOL. Tokens, NFTs, tradings have never been so fun!
                            </li>
                            <li>
                                Generate emoji on-the-fly based on the current chat context. Experience a smooth and
                            ...
                            <li>
                                Powered by Crynux. Hosting and training. Cost-efficient yet performant AI, from the
                                smallest user bases to the largest.
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="buy-media text-center">
                        <img src="@/assets/images/tg-demo.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="roadmap-section p-120">
        <div class="container">
            <div class="row">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1 col-12">
                    <div class="token-media">
                        <img src="@/assets/images/awe-logo-round.png" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="token-supply-main">
                        <div class="token-supply d-flex justify-content-between">
